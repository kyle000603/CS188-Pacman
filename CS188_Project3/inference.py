...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for pos in ghost_pos:
            ...
            prior = new_beliefs[pos]
            new_beliefs[pos] = prob * prior
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in ghost_pos:
            newPosDist = self.getPositionDistribution(gameState, oldPos)
            for new_pos, prob in newPosDist.items():
                new[new_pos] += new_beliefs[oldPos] * prob
        self.beliefs = new
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        self.particles = []
        "*** YOUR CODE HERE ***"
        part_per_pos = self.numParticles / len(self.legalPositions)
        for pos in self.legalPositions:
            for i in range(int(part_per_pos)):
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in ghost_pos:
            ...
            for pos, prob in newPosDist.items():
                distribution[pos] += beliefs[oldPos] * prob
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        # variable you store your particles in must be a list
        ghostPositions = list(ghostPositions)
        # However, the permutations are not returned in a random order.
        # you must then shuffle the list of permutations
        #   in order to ensure even placement of particles across the board.
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                if ghostDist is not None:
                    prob = prob * self.getObservationProb(ghostDist, pac_pos, particle[i], jail_pos)
                else:
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            "*** YOUR CODE HERE ***"
            for i in range(self.numGhosts):
                pos_dist = self.getPositionDistribution(gameState, oldParticle, i, self.ghostAgents[i])
                newParticle[i] = pos_dist.sample()
            """*** END YOUR CODE HERE ***"""
