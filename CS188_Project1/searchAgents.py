...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState: pacman.GameState):
        ...
        "*** YOUR CODE HERE ***"
        self.goalState = startingGameState.getFood()
        self.start = (self.startingPosition, self.goalState)
        self.checkFood = startingGameState.hasFood
